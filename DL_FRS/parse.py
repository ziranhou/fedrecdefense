...
def parse_args():
    ...
    parser.add_argument('-d', '--defense', '--NoDefense', default='NoDefense', choices=['NoDefense', 'NormBound', 'Bulyan', 'TrimmedMean', 'Krum', 'MultiKrum', 'Median', 'Regula', 'Ours'])
    ...
    # 添加 contribution_threshold 参数
    parser.add_argument('--contribution_threshold', type=float, default=0.1, help='Threshold for client contribution')
